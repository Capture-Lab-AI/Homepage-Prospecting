...
const points = [
  ...
  },
  {
    ...
    body: "Competitors hand you a static spreadsheet. Pipeline runs research continuously and updates the score as the world changes.",
  },
  {
    n: "03",
        ...
        <ScrollReveal>
          <div className="mb-16 max-w-3xl md:mb-24">
            ...
            <h2 className="font-display mt-5 text-balance text-[34px] font-light leading-[1.1] tracking-[-0.02em] text-ink md:text-[42px] lg:text-[48px]">
              Three things only Pipeline does.
            </h2>
          </div>
        </ScrollReveal>
