      ...
      <div className="mx-auto max-w-content px-6 py-24 md:py-32 lg:py-40">
        ...
        <div className="space-y-24 md:space-y-32">
          <Pillar
            ...
            body='Type a thesis in plain English: "3PL operators, 50–500 employees, expanding in Western PA, industrial." Pipeline runs the searches, scores candidates against your criteria, and hands back a ranked list. Accept the ones you want, skip the rest.'
          ...
          <Pillar
            ...
            body="The moment a company enters your pipeline, Pipeline pulls the website, finds the decision-makers, matches the HQ to property data, scans 90 days of news, and writes a plain-English brief. Refreshed nightly. No more stale notes."
            mockup={<EnrichMockup />}
            reverse
          />
          <Pillar
            ...
            body="Open your queue. Pick the top prospect. Pipeline streams a personalized email, call script, or LinkedIn note — grounded in their lease expiry, their recent funding round, your last conversation. Log the outcome, and the next touch schedules itself."
